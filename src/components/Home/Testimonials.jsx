        ...
        <div className="relative w-full h-full top-0 left-0 flex flex-col justify-center items-center gap-8 z-10 overflow-hidden">
          ...
          <div className="w-full flex 2xl:flex-row xl:flex-row lg:flex-row md:portrait:flex-col md:landscape:flex-row flex-col justify-center items-center">
            <div className="relative border border-[#FFF] testimonialShadow rounded-md costomBgLogos bg-[#f8eaff]/95 bg-[#ffffff33 w-[95%] flex 2xl:flex-row xl:flex-row lg:flex-row md:portrait:flex-col md:landscape:flex-row flex-col  justify-center items-center gap-3 px-7 py-7">
              ...
              <div className="flex justify-start items-start gap-4 flex-col z-10 bg-rd-500 2xl:w-1/2 xl:w-1/2 lg:w-1/2 md:portrait:w-full md:landscape:w-1/2 w-full">
                ...
                <div className="w-full flex justify-start gap-2 ">
                  {testimonialData.map((cur, id) => (
                    <div
                      ...
                      className={`testimonialCardBC min-w-[55%] py-3 px-3 flex justify-start items-center flex-col gap-5 transition-transform duration-200 ease-in-out`}
                    >
                      <div className="px-1 py-2 flex justify-start items-center gap-3 w-full  mx-auto borderGradient">
                        <div className="h-[3.5vw] w-[3.5vw] flex-shrink-0 rounded-full overflow-hidden">
                          <img
                            src={cur.image}
                            alt="personImg1"
                            loading="lazy"
                        ...
                        <div>
                          <h4 className=" 2xl:text-[1.15vw] xl:text-[1.15vw] lg:text-[1.15vw] md:portrait:text-[2.5vw] text-[2.8vw] font-[700] AllianceFont customLine__heights text-[#4d0072]">
                            {cur.name}
                          </h4>
                          <p className=" 2xl:text-[.8vw] xl:text-[.8vw] lg:text-[.8vw] md:portrait:text-[1.8vw] md:landscape:text-[.8vw] text-[2vw] font-[300] font-[Montserrat] text-[#2e0e4f]">
                            {cur.position}
                          </p>
                        </div>
                      </div>
